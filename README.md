...
- [X] What is React JS and what problems does it try and solve? Support your answer with concepts introduced in class and from your personal research on the web.
    ...
    React is a library for JS, that was created by Facebook, to both simplify and allow for creating more complex reactive websites. Uses a virtual dom and will render portions on a as needed basis.

- [X] What does it mean to _think_ in react?

    To think with the virtual Dom in mind

- [X] Describe state.

    It's a variable function pairing, allows you to simply change the contents of a variable.

- [X] Describe props.

    Props itslef is a bannana, but what we use it for it carrying information or functions from one component/file to another. This lets us create one component and use it with multiple diffent sources of data if need be.

- [X] What are side effects, and how do you sync effects in a React component to state or prop changes?

    Side effects, whether intentional or not, is when our function does more than expected. We use one "useEffect", to tell it when and how many times to invoke a function, in this project it was used to pull the api data, but ensure it is only done once.
